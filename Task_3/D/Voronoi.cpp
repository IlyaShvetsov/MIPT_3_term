...
//		x(x), y(y), z(z), prev(0), next(0) {}
//};
//
//
//
//const double INF = 1e99;
//static Point nil = { INF, INF, INF };
//Point *NIL = &nil;
//
//
//
...
//
//
//double time(Point *p, Point *q, Point *r)  // when turn changes
//{
//	if (p == NIL || q == NIL || r == NIL)
//		return INF;
...
//		std::cout << A[i]->prev - P << " " << A[i] - P << " " << A[i]->next - P << std::endl;
//
